...
*************************/
  ...
  *************************/
  ...
  POTENZA.offcanvasSidebar = function () {
    ...
    $(".offcanvas-sidebar .btn-close, .offcanvas-backdrop").on(
      "click",
      function () {
  ...
  *************************/
  gsap.set(
    ".awards-wrapper img.gsap-img-animation, .case-studies-wrapper img.gsap-img-animation, .blog-style-3 img.gsap-img-animation",
    { yPercent: -50, xPercent: -50 }
  );
  let activeImage;
  gsap.utils
    .toArray(".awards-item, .case-studies-item, .blog-style-3")
    .forEach((el) => {
  ...
  POTENZA.workspaces = function () {
    $(".workspaces-inner .workspaces-content").each(function () {
      ...
      blockHover.children(".workspaces-info-item").hover(function () {
        ...
        $(this)
          .parents(".workspaces-inner")
          .find(".workspaces-image-item")
